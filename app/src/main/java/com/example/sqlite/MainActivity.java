...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> ubicaci = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, UbicacionS);
        Ubicacion.setAdapter(ubicaci);
    ...
    public void RegistrarProducto(View view){
        ...
        if (!idProducto.isEmpty()) {
            ...
            if (fila.moveToFirst()) {
                ...
                Toast.makeText(this, "No se puede colocar misma ID", Toast.LENGTH_LONG).show();
    ...
    public void AbrirListadoProductos(View view){
        Intent intent = new Intent(MainActivity.this, ProductosRegistrados.class);
